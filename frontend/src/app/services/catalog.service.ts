  ...
  private services: ServiceItem[] = [
    {
      ...
      category: 'TÁNTRICO',
      description: 'Toques lentos, suaves y continuos por todo el cuerpo con aceites tibios neutros. Máxima relajación muscular y estimulación sensorial de pies a cabeza en atmósfera nocturna.',
      durationMinutes: 60,
      price: 200,
      imageUrl: 'assets/img/services/rc-01.webp',
      posterUrl: 'assets/img/services/rc-01.webp',
      videoUrl: 'videos/bubble-facial.mp4',
      tag: '✨ SENSITIVO FLORAL',
      features: ['Aceites Tibios Neutros', 'Estimulación Sensorial Continua', 'Cabina Climatizada'],
      featured: true
    },
    {
      id: 'rc-02',
      ...
      category: 'NURU',
      description: 'Masaje cuerpo a cuerpo sobre camilla especial con gel nuru tibio hiperdeslizante. Deslizamientos completos, contacto continuo e inmersión absoluta.',
      durationMinutes: 75,
      price: 280,
      ...
      tag: '💖 NURU BODY SLIDE',
      features: ['Gel Nuru Hiperdeslizante', 'Contacto Cuerpo a Cuerpo', 'Ducha de Alta Presión'],
      featured: true
    },
    {
      id: 'rc-03',
      ...
      description: 'Presión media y profunda para liberar sobrecargas en espalda, hombros y cuello. Termina con maniobras lentas de descanso y desconexión.',
      durationMinutes: 60,
      price: 180,
      imageUrl: 'assets/img/services/rc-03.webp',
      posterUrl: 'assets/img/services/rc-03.webp',
      videoUrl: 'videos/bubble-space.mp4',
      tag: '⚡ DESCONTRACTURANTE',
      features: ['Descompresión Cervical', 'Puntos Gatillo', 'Aromaterapia Relax'],
      featured: true
    },
    {
      id: 'rc-04',
      ...
      category: 'TÁNTRICO',
      description: 'Sesión tántrica integral que combina maniobras sensitivas lentas con piedras tibias de cuarzo, aceites aromáticos y música binaural envolvente.',
      durationMinutes: 75,
      price: 250,
      imageUrl: 'assets/img/services/rc-04.webp',
      posterUrl: 'assets/img/services/rc-04.webp',
      videoUrl: 'videos/bubble-hero.mp4',
      tag: '🔮 TÁNTRICO INTEGRAL',
      features: ['Piedras Tibias de Cuarzo', 'Estimulación de Chakras', 'Música Binaural'],
      featured: true
    },
    {
      id: 'rc-05',
      ...
      category: '4 MANOS',
      description: 'Dos masajistas sincronizadas trabajando al mismo tiempo de manera armónica. La experiencia sensitiva definitiva de sobrecarga sensorial positiva.',
      durationMinutes: 60,
      price: 380,
      ...
      tag: '👑 SINCRONÍA DÚO',
      features: ['2 Terapeutas Sincronizadas', 'Maniobras Espejo', 'Máxima Relajación'],
      featured: true
    },
    {
      id: 'rc-06',
      code: 'RC-06',
      name: 'Masaje RECOVR VIP Hidromasaje',
      category: 'VIP',
      description: 'La sesión más completa: masaje tántrico sensitivo, técnica cuerpo a cuerpo Nuru y tiempo de tina de hidromasaje privada con microburbujas en suite.',
      durationMinutes: 90,
      price: 450,
      imageUrl: 'assets/img/services/rc-06.webp',
      posterUrl: 'assets/img/services/rc-06.webp',
      videoUrl: 'videos/video-project-27.mp4',
      tag: '💎 EXPERIENCIA VIP',
      features: ['Tina Privada con Hidromasaje', 'Cuerpo a Cuerpo Nuru', 'Champagne & Frutas'],
      featured: true
    }
  ];
